/*! markdown-it-emoji 1.3.0 https://github.com//markdown-it/markdown-it-emoji @license MIT */ ! function(a) {
      ...
      e.exports = function(a, e, n, o, i) {
        ...
        return function(a) {
          ...
          for (n = 0, i = l.length; n < i; n++)
            if ("inline" === l[n].type)
              for (t = l[n].children, e = t.length - 1; e >= 0; e--) s = t[e], "link_open" !== s.type && "link_close" !== s.type || "auto" === s.info && (c -= s.nesting), "text" === s.type && o.test(s.content) && 0 === c && (l[n].children = t = _(t, e, r(s.content, s.level, a.Token)))
        }
      }
    }, {}],
    6: [function(a, e, n) {
